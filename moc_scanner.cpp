...
static const char qt_meta_stringdata_scanner[] = {
    "scanner\0\0newData(QByteArray)\0stop()\0"
};
...
const QMetaObjectExtraData scanner::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject scanner::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_scanner,
      qt_meta_data_scanner, &staticMetaObjectExtraData }
};
...
// SIGNAL 0
void scanner::newData(QByteArray _t1)
{
